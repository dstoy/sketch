<script lang="ts">
    import { Docs, Prop, Example } from "sketch";

    export const sketch = "Nested/First";
</script>
...
<Docs>
    <Prop name="name" type="Boolean" default={false}>
        The property description goes here.<br />
        It may be on a few lines
    </Prop>
    <Prop name="name" type="Boolean" default={false}>
        The property description goes here.<br />
        It may be on a few lines
    </Prop>
    <Prop name="name" type="Boolean">
        The property description goes here.<br />
        It may be on a few lines
    </Prop>
    <Prop name="name" type="Boolean" default={false}>
